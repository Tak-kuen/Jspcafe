...
<link rel="stylesheet" href="/jsp_project/css/mileageForm.css" type="text/css" />
<script src="/jsp_project/js/jquery-3.3.1.min.js"></script>

<div id="mileagemanagement">
<h2>마일리지 관리</h2>
	<div id="mileageset">
		적립금 설정: <input name="set" id="set" type="text" maxlength="10" size="10">
		원 이상 구매 시 <input name="set2" id="set2" type="text" maxlength="10" size="10">
		% 적립<br />
		사용 제한&nbsp;&nbsp;&nbsp;:&nbsp;<input name="set3" id="set3" type="text"
			maxlength="10" size="10"> 원 이상 보유 시 <input name="set4" id="set4"
			type="text" maxlength="10" size="10"> 원 단위로 사용 가능 <input type="button"
			id="setBtn" value="적용">
	</div>
</div>
<script>
